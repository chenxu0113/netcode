...
typedef  void ( CALL_METHOD *pfSearchDeviceCallBack)(SDK_CONFIG_NET_COMMON_V2  *pNetCom , unsigned int userData);
//
/*
	...
	返回值:
		...
		false:失败
*/
H264_DVR_API bool CALL_METHOD H264_DVR_SearchDevice_V2(pfSearchDeviceCallBack pfNetCom,unsigned int userData, int nSearchTime);
...
/*
	描述:查询设备是否在线,已弃用,使用H264_DVR_Check_Device_Exist_V2更精准
*/
...
/*
	...
	<0:失败
*/
H264_DVR_API long CALL_METHOD H264_DVR_GetUpgradeVersion(long lLoginID,SDK_CloudUpgradeVersionReq* versionInfo, char * lpOutBuffer,unsigned long dwOutBufferSize,unsigned long* lpBytesReturned,int waittime/*=500*/);
#endif
