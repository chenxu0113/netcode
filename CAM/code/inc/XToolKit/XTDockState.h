...
//////////////////////////////////////////////////////////////////////
// CXTControlBarInfo is a CControlBarInfo derived class.  It is used to
...
public:
	...
	// file with SaveState. Returns TRUE if successful, otherwise returns
	// FALSE.
	//
	BOOL LoadState(
		// Points to a null-terminated string that specifies the name of a section
		// in the initialization file or a key in the Windows registry where
		// state information is stored.
		LPCTSTR lpszProfileName,
		// Index of the control bar in the array.
		int nIndex,
		// A pointer to a valid CDockState object.
		CDockState* pDockState);
	
	// Call this function to save the state information to the registry or
	...
	// bar information from the registry or .INI file with LoadState. Returns
...
//////////////////////////////////////////////////////////////////////
// CXTDockState is a serialized CObject derived class.  It loads, unloads,
