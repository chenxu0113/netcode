...
// An RGB value that represents the XP base color.
const UINT XPCOLOR_BASE                     =  30;
// An RGB value that represents the XP toolbar background color.
const UINT XPCOLOR_BARFACE                  =  XPCOLOR_BASE;
// An RGB value that represents the XP menu item selected color.
const UINT XPCOLOR_HIGHLIGHT                =  31;
// An RGB value that represents the XP menu item selected border color.
const UINT XPCOLOR_HIGHLIGHT_BORDER         =  32;
// An RGB value that represents the XP menu item pushed color.
const UINT XPCOLOR_HIGHLIGHT_PUSHED         =  33;
// An RGB value that represents the XP menu item icon shadow
const UINT XPCOLOR_ICONSHADDOW              =  34;
// An RGB value that represents the XP menu item disabled text color.
const UINT XPCOLOR_GRAYTEXT                 =  35;
// An RGB value that represents the XP menu item checked color.
const UINT XPCOLOR_HIGHLIGHT_CHECKED        =  36;
// An RGB value that represents the XP menu item checked border color.
const UINT XPCOLOR_HIGHLIGHT_CHECKED_BORDER =  37;
// An RGB value that represents the XP toolbar gripper color.
const UINT XPCOLOR_GRIPPER                  =  38;
// An RGB value that represents the XP toolbar separator color.
const UINT XPCOLOR_SEPARATOR                =  39;
// An RGB value that represents the XP menu icon disabled color.
const UINT XPCOLOR_DISABLED                 =  40;
// An RGB value that represents the XP menu item text background color.
const UINT XPCOLOR_MENUTEXT_BACK            =  41;
// An RGB value that represents the XP hidden menu commands background color.
const UINT XPCOLOR_MENU_EXPANDED            =  42;
// An RGB value that represents the XP menu border color.
const UINT XPCOLOR_MENU_BORDER              =  43;
// An RGB value that represents the XP menu item text color.
const UINT XPCOLOR_MENUTEXT                 =  44; 
// An RGB value that represents the XP menu item selected text color.
const UINT XPCOLOR_HIGHLIGHT_TEXT           =  45;
// An RGB value that represents the XP toolbar text color.
const UINT XPCOLOR_BARTEXT                  =  46;
// An RGB value that represents the XP toolbar pushed text color.
const UINT XPCOLOR_BARTEXT_PUSHED           =  47;
// An RGB value that represents the XP inactive tab background color.
const UINT XPCOLOR_TAB_INACTIVE_BACK        =  48;
// An RGB value that represents the XP inactive tab text color.
...
// Minimum control ID value for a CXTControlBar (59392).
const UINT XT_IDW_CONTROLBAR_MIN   = AFX_IDW_CONTROLBAR_FIRST; 
// Maximum control ID value for a CXTControlBar (59647).
const UINT XT_IDW_CONTROLBAR_MAX   = AFX_IDW_CONTROLBAR_LAST;  
// Minimum command ID for tools manager user defined commands (53000).
const UINT XT_IDC_TOOLSMANAGER_MIN = 0xCF08;
// Maximum command ID for tools manager user defined commands (53250).
const UINT XT_IDC_TOOLSMANAGER_MAX = 0xD002;

//////////////////////////////////////////////////////////////////////////
//:Associate with "Styles - CXTSplitterDock"
//////////////////////////////////////////////////////////////////////////

// Vertical docking window splitter.
const UINT XT_SPLITTER_VERT        = 0x0001; 
// Horizontal docking window splitter.
const UINT XT_SPLITTER_HORZ        = 0x0002; 

//////////////////////////////////////////////////////////////////////////
//:Associate with "Styles - CXTSplitterWnd"
//////////////////////////////////////////////////////////////////////////

// Has a dotted tracker.
const UINT XT_SPLIT_DOTTRACKER     = 0x0001; 
// Show pane contents while dragging.
const UINT XT_SPLIT_NOFULLDRAG     = 0x0002; 
// Do not draw a border around the pane.
const UINT XT_SPLIT_NOBORDER       = 0x0004; 
// Do allow sizing.
const UINT XT_SPLIT_NOSIZE         = 0x0008; 

//////////////////////////////////////////////////////////////////////////
//:Associate with "Styles - CXTDockWindow"
//////////////////////////////////////////////////////////////////////////

// Has a gripper when docked.
const UINT CBRS_XT_GRIPPER         = 0x0001; 
// Draws text in the gripper area when docked.  Only valid with CBRS_XT_GRIPPER styles.
const UINT CBRS_XT_GRIPPER_TEXT    = 0x0002; 
// Has a gripper with two grip bars.
const UINT CBRS_XT_TWOGRIP         = 0x0004; 
// Has a flat gripper.  Must be used with CBRS_XT_GRIPPER.
const UINT CBRS_XT_GRIPPER_FLAT    = 0x0008; 
// Has a gradient style gripper.  Must be used with CBRS_XT_GRIPPER_FLAT.
const UINT CBRS_XT_GRIPPER_GRAD    = 0x0010; 
// Has min, max, and close frame buttons.
const UINT CBRS_XT_BUTTONS         = 0x0020; 
// Draws buttons flat.  Only valid with CBRS_XT_BUTTONS style.
const UINT CBRS_XT_BUTTONS_FLAT    = 0x0040; 
// Draws the borders flat.
const UINT CBRS_XT_BORDERS_FLAT    = 0x0080; 
// Draws buttons and borders with a thin 3D border.
const UINT CBRS_XT_SEMIFLAT        = 0x0100; 
// Draws an outline around the client area.
const UINT CBRS_XT_CLIENT_OUTLINE  = 0x0200; 
// Draws a static rect around the client area.
const UINT CBRS_XT_CLIENT_STATIC   = 0x0400; 
// Draws a modal rect around the client area.
const UINT CBRS_XT_CLIENT_MODAL    = 0x0800; 
// Used internally by docking windows.
const UINT CBRS_XT_NEWDOCKED       = 0x1000; 
// Same as CBRS_XT_BUTTONS | CBRS_XT_GRIPPER | CBRS_XT_GRIPPER_TEXT.
const UINT CBRS_XT_DEFAULT         = 0x0023; 
// Same as CBRS_XT_DEFAULT | CBRS_XT_GRIPPER_FLAT | CBRS_XT_BUTTONS_FLAT | CBRS_XT_BORDERS_FLAT.
const UINT CBRS_XT_ALL_FLAT        = 0x00EB; 
...
// 3D borders.
const UINT CBRS_XT_NONFLAT         = 0x0000; 
// Flat borders.
const UINT CBRS_XT_FLAT            = 0x0080; 
...
// Draws a flat button.
const UINT BS_XT_FLAT              = 0x0001; 
// Draws a semi-flat button.
const UINT BS_XT_SEMIFLAT          = 0x0002; 
// Draws images and text are centered.
const UINT BS_XT_TWOROWS           = 0x0004; 
...
// Draws a focus rect when the button has input focus.
const UINT BS_XT_SHOWFOCUS         = 0x0010; 
// Highlights the button when pressed.
const UINT BS_XT_HILITEPRESSED     = 0x0020; 
// Draws a flat button ala Office XP.
const UINT BS_XT_XPFLAT            = 0x0040; 
// Uses Windows XP themes if available.  This setting overrides BS_XT_FLAT and BS_XT_SEMIFLAT, but [i]does not[/i] override BS_XT_XPFLAT.
const UINT BS_XT_WINXP_COMPAT      = 0x1000; 

//////////////////////////////////////////////////////////////////////////
//:Associate with "Styles - CXTBrowseEdit"
//////////////////////////////////////////////////////////////////////////

// Display the choose folder dialog.
const UINT BES_XT_CHOOSEDIR        = 0x0001; 
// Display the choose file dialog.
const UINT BES_XT_CHOOSEFILE       = 0x0002; 
// Display a user defined context menu.
const UINT BES_XT_POPUPMENU        = 0x0004; 

//////////////////////////////////////////////////////////////////////////
//:Associate with "Styles - CXTColorPopup"
//////////////////////////////////////////////////////////////////////////

// Use No Fill style in place of Automatic.
const UINT CPS_XT_NOFILL           = 0x0001; 
// Display extended colors.
const UINT CPS_XT_EXTENDED         = 0x0002; 
// Display more colors button.
const UINT CPS_XT_MORECOLORS       = 0x0004; 
// *** Used internally by the color popup window.
const UINT CPS_XT_PICKBOX          = 0x0008; 
// *** Used internally by the color popup window.
const UINT CPS_XT_DEFAULT          = 0x0010; 

// Display a list of user selected colors.
const UINT CPS_XT_USERCOLORS       = 0x0020; 
...
const UINT CPS_XT_SHOWHEXVALUE     = 0x0020; 
// Shows new / current display box with a 3D border.
const UINT CPS_XT_SHOW3DSELECTION  = 0x0040; 
...
// Standard edit field.
const UINT LBS_XT_DEFAULT          = 0x0000; 
// Choose directory browse edit field.
const UINT LBS_XT_CHOOSEDIR        = 0x0001; 
// Choose file browse edit field.
const UINT LBS_XT_CHOOSEFILE       = 0x0002; 
// Do not display edit toolbar.
const UINT LBS_XT_NOTOOLBAR        = 0x0008; 
...
// Show a 3D border.
const UINT TWS_XT_THICKBORDER      = 0x0001; 
// Show a drop shadow when the window is active.
const UINT TWS_XT_DROPSHADOW       = 0x0002; 
// Show alpha style drop shadow.
const UINT TWS_XT_ALPHASHADOW      = 0x0004; 

//////////////////////////////////////////////////////////////////////////
//:Associate with "Styles - CXTCaption"
//////////////////////////////////////////////////////////////////////////

// Show the caption with a sunken border.
const UINT CPWS_EX_GROOVE_EDGE     = 0x0001; 
// Show the caption with a raised border.
const UINT CPWS_EX_RAISED_EDGE     = 0x0002; 
// Caption has a close button.
const UINT CPWS_EX_CLOSEBUTTON     = 0x0004; 
...
// Displays the Toolbars tab in the toolbar customize property sheet.
const UINT CUST_XT_TOOLBARS        = 0x0001;
// Displays the Commands tab in the toolbar customize property sheet.
const UINT CUST_XT_COMMANDS        = 0x0002;
// Displays the Keyboard tab in the toolbar customize property sheet.
const UINT CUST_XT_KEYBOARD        = 0x0004;
// Displays the Tools tab in the toolbar customize property sheet.
const UINT CUST_XT_TOOLS           = 0x0008;
// Displays the Options tab in the toolbar customize property sheet.
const UINT CUST_XT_OPTIONS         = 0x0010;
// Same as CUST_XT_TOOLBARS|CUST_XT_COMMANDS|CUST_XT_KEYBOARD|CUST_XT_TOOLS|CUST_XT_OPTIONS.
const UINT CUST_XT_DEFAULT         = (CUST_XT_TOOLBARS|CUST_XT_COMMANDS|CUST_XT_KEYBOARD|CUST_XT_TOOLS|CUST_XT_OPTIONS);

//////////////////////////////////////////////////////////////////////////
//:Associate with "Styles - CXTOutBarCtrl"
//////////////////////////////////////////////////////////////////////////

// Sets small icon mode.
const UINT OBS_XT_SMALLICON        = 0x0001; 
// Sets large icon mode.
const UINT OBS_XT_LARGEICON        = 0x0002; 
// Enables folder local editing (renaming).
const UINT OBS_XT_EDITGROUPS       = 0x0004; 
// Enables item local editing (renaming).
const UINT OBS_XT_EDITITEMS        = 0x0008; 
// Enables the "Remove" command for folders in context menu.
const UINT OBS_XT_REMOVEGROUPS     = 0x0010; 
// Enables the "Remove" command for items in context menu.
const UINT OBS_XT_REMOVEITEMS      = 0x0020; 
// Enables folder insertion.
const UINT OBS_XT_ADDGROUPS        = 0x0040; 
// Enables item dragging to rearrange position.
const UINT OBS_XT_DRAGITEMS        = 0x0080; 
// Enables animation while changing folder selection.
const UINT OBS_XT_ANIMATION        = 0x0100; 
// Enables dimmed highlight of last pressed item.
const UINT OBS_XT_SELHIGHLIGHT     = 0x0200; 
// Same as OBS_XT_DRAGITEMS | OBS_XT_EDITGROUPS | OBS_XT_EDITITEMS | OBS_XT_REMOVEGROUPS | OBS_XT_REMOVEITEMS | OBS_XT_ADDGROUPS.
...
// For determining tree item focus state.
const UINT TVIS_FOCUSED            = 0x0001; 

//:Associate with "Notification Handlers - CXTColorPicker"
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnSelChange( );[/b][/pre]
//
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnDropDown( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnCloseUp( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnSelEndOk( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever a
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnSelEndCancel( );[/b][/pre]
//
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever a
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnSelNoFill( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnLabelEditEnd( );[/b][/pre]
//
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnLabelEditCancel( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnNewItem( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnPreDeleteItem( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner just before an item
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnDeleteItem( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnMoveItemUp( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnMoveItemDown( );[/b][/pre]
//
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  The TIN_XT_TRAYICON message is sent to the CXTTrayIcon window's owner
...
//
//  [i]uID[/i]
//  Value of wParam specifies the resource ID of the icon associated with the
//  CXTTrayIcon object.
//
//  [i]uMouseMsg[/i]
//  Value of lParam specifies the mouse or keyboard message associated with the event.
//
//  [h4]Return Values[/h4]
//  If the application is to process this message, the return value should be 0.
//
//  [h4]Remarks[/h4]
...
/////////////////////////////////////////////////////////////////////////////
//  The CBRN_XT_CONTEXTMENU message is sent to the CXTControlBar window's owner
...
//
//  [i]pBar[/i]
//  Value of wParam specifies a CXTControlBar object that represents the toolbar
...
//
//  [h4]Remarks[/h4]
//  When the user right clicks on a control bar, the CBRN_XT_CONTEXTMENU
//  message is sent to the control bar's owner window. 
//
//  [h4]Example[/h4]
//  Here is an example of how an application would process the CBRN_XT_CONTEXTMENU 
//  message. 
//
//[pre]BEGIN_MESSAGE_MAP(CMainFrame, CXTMDIFrameWnd)
//    //{{AFX_MSG_MAP(CMainFrame)
...
/////////////////////////////////////////////////////////////////////////////
//  The CBRN_XT_DROPDOWN message is sent to the CXTToolBar window 
...
//
//  [i]pNMTB[/i]
//  Value of wParam specifies a NMTOOLBAR structure that represents the toolbar
//  button where the dropdown event occurred.
//
//  [i]pRect[/i]
//  Value of lParam points to a CRect object that represents the size and location
//  of the toolbar button where the dropdown event occurred.
//
//  [h4]Return Values[/h4]
//  If the dropdown is displaying a modal window, the return value should be 0, otherwise
//  return 1 for menu style displays.
//
//  [h4]Remarks[/h4]
//  When the user clicks on a dropdown arrow for a toolbar button, the CBRN_XT_DROPDOWN
//  message is sent to the toolbar's owner window. 
//
//  [h4]Example[/h4]
//  Here is an example of how an application would process the CBRN_XT_DROPDOWN 
//  message. 
//
//[pre]BEGIN_MESSAGE_MAP(CMainFrame, CXTMDIFrameWnd)
//    //{{AFX_MSG_MAP(CMainFrame)
...
/////////////////////////////////////////////////////////////////////////////
//  The XTWM_OUTBAR_NOTIFY message is sent to the CXTOutBarCtrl owner window 
...
//
//  [i]nBarAction[/i]
//  Value of wParam specifies an Outlook bar value that indicates the users 
...
//
//  [i]pOBInfo[/i]
//  Value of lParam points to an XT_OUTBAR_INFO structure that contains information for the 
...
//  
//  [h4]Return Values[/h4]
//  If the application is to process this message, the return value should be TRUE. If the 
//  return value is FALSE, the user's action is ignored. 
//
//  [h4]Remarks[/h4]
//  When the user performs an action in the Outlook bar, the XTWM_OUTBAR_NOTIFY message is 
...
// Item was selected.  See XTWM_OUTBAR_NOTIFY.
const UINT OBN_XT_ITEMCLICK        = 1;      
// Item label edit completed.  See XTWM_OUTBAR_NOTIFY.
const UINT OBN_XT_ONLABELENDEDIT   = 2;      
// Folder label edit completed.  See XTWM_OUTBAR_NOTIFY.
const UINT OBN_XT_ONGROUPENDEDIT   = 3;      
// Item drag operation in process.  See XTWM_OUTBAR_NOTIFY.
const UINT OBN_XT_DRAGITEM         = 4;      
// Folder selection changed.  See XTWM_OUTBAR_NOTIFY.
const UINT OBN_XT_FOLDERCHANGE     = 5;      
// Mouse is hovering over item.  See XTWM_OUTBAR_NOTIFY.
const UINT OBN_XT_ITEMHOVER        = 6;      
// Item deleted.  See XTWM_OUTBAR_NOTIFY.
const UINT OBN_XT_DELETEITEM       = 7;      
// Folder deleted.  See XTWM_OUTBAR_NOTIFY.
const UINT OBN_XT_DELETEFOLDER     = 8;      
// Item drag operation begun.  See XTWM_OUTBAR_NOTIFY.
const UINT OBN_XT_BEGINDRAG        = 9;      
// Right click on Outlook bar occurred.  See XTWM_OUTBAR_NOTIFY.
...
/////////////////////////////////////////////////////////////////////////////
//  The XTWM_SHELL_NOTIFY message is sent to the CXTShellTree and list owner window 
...
//
//  [i]nShellAction[/i]
//  Value of wParam specifies a shell tree value that indicates the users 
//  request. This parameter can be one of the following values:
//
//  [ul]
...
//
//  [i]pItemData[/i]
//  Value of lParam points to an XT_TVITEMDATA structure that contains information for the 
...
//
//  [h4]Remarks[/h4]
//  When the user performs an action in the shell tree, the XTWM_SHELL_NOTIFY message is 
...
// Shell context menu selection made.  See XTWM_SHELL_NOTIFY
const UINT SHN_XT_SHELLMENU        = 1;      
// Tree selection made.  See XTWM_SHELL_NOTIFY.
const UINT SHN_XT_TREESELCHANGE    = 2;      
// Child tree node selected.  See XTWM_SHELL_NOTIFY.
const UINT SHN_XT_SELECTCHILD      = 3;      
// Item selected was not a folder.  See XTWM_SHELL_NOTIFY.
const UINT SHN_XT_NOFOLDER         = 4;      
// Item selected was the internet folder.  See XTWM_SHELL_NOTIFY.
const UINT SHN_XT_INETFOLDER       = 5;      

//:Associate with "Notification Handlers - CXTTabCtrl"
/////////////////////////////////////////////////////////////////////////////
//  The TCN_XT_SELCHANGE message is sent to the owner of a CXTTabCtrl whenever
...
//
//  [i]nID[/i]
//  Dialog control ID for the tab control.
//
//  [i]pTabCtrl[/i]
//  Points to the tab control whose selection has changed.
//
//  [h4]Remarks[/h4]
//  When the user selects a new tab in the tab control, the TCN_XT_SELCHANGE message is 
...
//:Associate with "Notification Handlers - CXTTabCtrl"
/////////////////////////////////////////////////////////////////////////////
//  The TCN_XT_SELCHANGING message is sent to the owner of a CXTTabCtrl whenever
...
//
//  [i]pTabCtrl[/i]
//  Points to the tab control whose selection is about to change.
//
//  [h4]Remarks[/h4]
//  When the user selects a new tab in the tab control, the TCN_XT_SELCHANGING message is 
//  sent to the tab control's owner window. 
//
//  [h4]Example[/h4]
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnItemExpanding( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnItemExpand( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnItemContracting( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  
//[pre]function prototype: [b]afx_msg void OnItemContract( );[/b][/pre]
//  
//  [h4]Remarks[/h4]
//  This command handler is called to inform the owner whenever the
...
/////////////////////////////////////////////////////////////////////////////
//  The XTWM_ADDREBAR message is sent to a window whenever it is added
...
//
//  [i]bHorz[/i]
//  TRUE if horizontally oriented, FALSE otherwise.
//
//  [i]pRBBI[/i]
//  A pointer to a BARBANDINFO structure, the window can modify its parameters as appropriate.
//
//  [h4]Return Values[/h4]
//  If the application is to process this message, the return value should be TRUE.
//
//  [h4]Remarks[/h4]
//  When a window is added to a rebar, the XTWM_ADDREBAR message is sent to the window. 
//
//  [h4]Example[/h4]
//  Here is an example of how an application would process the XTWM_ADDREBAR 
//  message. 
//
...
//:Associate with "Notification Handlers - CXTReBar"
/////////////////////////////////////////////////////////////////////////////
//  The XTWM_REBAR_SIZECHILD message is sent when CXTReBar control has resized 
...
//
//  [i]pRBSCI[/i]
//  A pointer to an XT_REBARSIZECHILDINFO structure, the window can modify its parameters as appropriate.
//
//  [h4]Return Values[/h4]
//  If the application is to process this message, the return value should be TRUE.
//
//  [h4]Remarks[/h4]
//  When a window is added to a rebar, the XTWM_REBAR_SIZECHILD message is sent to the window. 
//
//  [h4]Example[/h4]
//  Here is an example of how an application would process the XTWM_REBAR_SIZECHILD 
//  message. 
//
//[pre]BEGIN_MESSAGE_MAP(CWidget, CWnd)
//    //{{AFX_MSG_MAP(CWidget)
...
/////////////////////////////////////////////////////////////////////////////
//  CXTDockContext sends the XTWM_QUERYVISUALIZE message to a control bar to 
...
//  
//  [h4]Return Values[/h4]
//  TRUE if the control bar shall be fully visualized, FALSE if just a wire frame must be rendered.
//
//  [h4]Remarks[/h4]
//  When a control bar is dragged the XTWM_QUERYVISUALIZE message is sent to the control bar. 
//
//  [h4]Example[/h4]
//  Here is an example of how an application would process the XTWM_QUERYVISUALIZE 
//  message. 
//  
...
//:Associate with "Notification Handlers - CXTDockContext"
/////////////////////////////////////////////////////////////////////////////
//  CXTDockContext sends the XTWM_QUERYHOTSPOT message to a control bar to 
...
//
//  [h4]Return Values[/h4]
//  TRUE if control bar has a hot spot, FALSE if it does not.
//
//  [h4]Remarks[/h4]
//  CXTDockContext sends the XTWM_QUERYHOTSPOT message the control bar to check 
//  for a hot spot. 
//
//  [h4]Example[/h4]
//  Here is an example of how an application would process the XTWM_QUERYHOTSPOT 
//  message. 
//
//[pre]BEGIN_MESSAGE_MAP(CWidget, CXTControlBar)
//    //{{AFX_MSG_MAP(CWidget)
...
/////////////////////////////////////////////////////////////////////////////
//  The XTWM_PROPERTYGRID_NOTIFY message is sent to the CXTPropertyGrid owner window 
...
//
//  [i]pItem[/i]
//  Value of lParam points to an CXTPropertyGridItem object that contains information for the 
...
// The sort order has changed in the property grid.
const UINT XT_PGN_SORTORDER_CHANGED = 1;
// The selection has changed in the property grid.
const UINT XT_PGN_SELECTION_CHANGED = 2;
// The value has changed for pItem in the property grid.
const UINT XT_PGN_ITEMVALUE_CHANGED = 3;
...
//////////////////////////////////////////////////////////////////////
// This macro will free the dynamically allocated memory specified by 
...
//////////////////////////////////////////////////////////////////////
// This macro will free the dynamically allocated memory for an array 
...
//////////////////////////////////////////////////////////////////////
// This macro will release the resources for the COM object specified 
...
#endif
// The I_IMAGENONE constant is used when defining text-only toolbar buttons with no
