...
//////////////////////////////////////////////////////////////////////
// CXTOleIPFrameWnd is a multiple inheritance class derived from COleIPFrameWnd
...
public:
    ...
    // Constructs a CXTOleIPFrameWnd object.
    //
	CXTOleIPFrameWnd();

	// Destroys a CXTOleIPFrameWnd object, handles cleanup and de-allocation.
    //
...
public:
	...
	// with the frame. Returns a CXTCoolMenu pointer that represents the cool
	...
	// the frame. Returns a CXTMenuBar pointer that represents the menu bar
    ...
    // This member function is called by the frame window to save the
	// settings of the control bar.
    //
