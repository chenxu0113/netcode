...
public:
    ...
    //
	CXTRegistryManager(
		// Current key to be used in the registry.
		HKEY hKeyBase = HKEY_CURRENT_USER);

	// Destroys a CXTRegistryManager object, handles cleanup and de-allocation.
    //
	virtual ~CXTRegistryManager();

protected:

	// Handle to the registry key to use.  The default is HKEY_CURRENT_USER.	
	HKEY m_hKeyBase;
	// Name of an .INI file for registry settings.
	CString m_strINIFileName;
	// Points to an application's CWinApp object.
	CWinApp* m_pWinApp;
...
public:
	...
	// used by the registry manager. Returns a CString object.
	//
    CString GetINIFileName();

    // Call this member function to write the specified INT value into
	// the specified section of the application’s registry or .INI file. Returns
    ...
    BOOL WriteProfileInt(
        ...
        LPCTSTR lpszSection,
        // Points to a null-terminated string that contains the entry into
    ...
    BOOL WriteProfileBinary(
        ...
        // Contains the value to be written.
        LPBYTE pData,
        // Contains the size of the value to be written.
        UINT nBytes);
	...
	// .INI file. Returns the integer value of the string that follows the
    ...
    UINT GetProfileInt(
        ...
        LPCTSTR lpszSection,
        // Points to a null-terminated string that contains the entry whose
		// value is to be retrieved.
        LPCTSTR lpszEntry,
        // Specifies the default value to return if the framework cannot
    ...
    BOOL GetProfileBinary(
        ...
        // value is to be retrieved.
        LPCTSTR lpszEntry,
        // Address of a LPBYTE data member to receive the value.  It is the
        // caller's responsibility to free the memory allocated for 'ppData'. 
        // An example of this would be:
        //
        //[pre]void CXTDockWindow::LoadBarSize(CString strSection)
        //{
        ...
        //
        BYTE** ppData,
        // Address of a UINT to receive the size of 'ppData'.
        UINT* pBytes);
    ...
    CString GetProfileString(
		...
		// value is to be retrieved.
        LPCTSTR lpszEntry,
        // Points to the default string value for the given entry if the
    ...
    BOOL GetProfilePoint(
		...
		// value is to be retrieved.
        LPCTSTR lpszEntry,
        // Points to the variable to be filled from the registry.
        CPoint * ptResult);
	...
	// Call this function to fill a CMap (CString to DWORD) with the names
	...
	int EnumValues(
        ...
        // the entry.
        LPCTSTR lpszSection,
		// A reference to a CMap<CString, LPCTSTR, DWORD, DWORD&>, which will contain
		// the items in the registry under this section.  Can be NULL.
		// Does not include subsection names.
		CMap<CString, LPCTSTR, DWORD, DWORD&> * mapItems,
		// A reference to a CStringArray which, if not NULL, will contain an array
	...
	int EnumKeys(
		...
		// containing the entry.
        LPCTSTR lpszSection,
		// A reference to a CStringArray, which will contain the keys in the
		// registry under the above key.
		CStringArray & arrayKeys);

	// Call this function to delete a registry key, and all its contents.
	...
	bool DeleteKey(
		...
		// containing the entry.
        LPCTSTR lpszSection,
		// Points to a null-terminated string that specifies the subkey to delete.
		LPCTSTR lpszKey);

	// Call this function to delete a registry value. Returns 'true' if successful,
	...
	bool DeleteValue(
		...
		// containing the entry.
        LPCTSTR lpszSection,
		// Points to a null-terminated string that specifies the value to delete.
		LPCTSTR lpszKey);
