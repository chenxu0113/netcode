...
// A base class for delegates defined here
...
protected:
	// a target on which to invoke the callback
	CObject* m_target;
	// a callback
	CB m_cb;
...
public:
	...
	// removes all registrations for a target
	...
	// frees up the memory once there is nothing in the array
	void ReleaseMemory()
	{
		if (GetSize() == 0)
		{
