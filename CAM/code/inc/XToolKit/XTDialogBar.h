...
//////////////////////////////////////////////////////////////////////
// The CXTDialogBar class provides the functionality of a Windows modeless
...
public:
    ...
    // Constructs a CXTDialogBar object.
    //
    CXTDialogBar();

    // Destroys a CXTDialogBar object, handles cleanup and de-allocation.
    //
...
public:
    ...
    // This member function loads the dialog box resource template specified
    ...
    virtual BOOL Create(
        ...
        CWnd* pParentWnd,
		// A pointer to the name of the CXTDialogBar 
        // object’s dialog box resource template.
        LPCTSTR lpszTemplateName,
		// The alignment style of the dialog bar. The 
    ...
    virtual BOOL Create(
		// A pointer to the parent CWnd object.
        CWnd* pParentWnd,
		// The resource ID of the CXTDialogBar object’s 
        // dialog box template.
        UINT nIDTemplate,
		// The alignment style of the dialog bar. The 
        // following styles are supported:
