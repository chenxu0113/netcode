...
//////////////////////////////////////////////////////////////////////
// CXTFrameWnd is a multiple inheritance class derived from CFrameWnd and
...
public:
    ...
    // Constructs a CXTFrameWnd object.
    //
    CXTFrameWnd();

    // Destroys a CXTFrameWnd object, handles cleanup and de-allocation.
    //
    virtual ~CXTFrameWnd();
...
public:
    ...
    // Call this member function to switch views for your SDI application.
    //
    virtual void SwitchSDIView(
        // A pointer to a CRuntimeClass structure associated with your
		// view.
        CRuntimeClass *pViewClass,
        // A pointer to the document to be used with the view. If NULL
		// the same document will be used for all SDI views.
        CDocument *pDocument=NULL,
        // Specifies the type of view and document, if NULL this will be 
        // created for you.
        CCreateContext *pContext=NULL);

    // Call this member function to retrieve a pointer to the cool menu
	// object associated with the frame.  Returns a CXTCoolMenu pointer that
	// represents the cool menu object associated with the frame.
    //          
    CXTCoolMenu* GetCoolMenu();

    // Call this member function to retrieve a pointer to the menu bar associated
	// with the frame.  Returns a CXTMenuBar pointer that represents the menu bar
    ...
    void EnableDockingEx(
		...
		// dock.
        DWORD dwDockStyle,
        // Specifies the splitter's, inside dockbars, look. It can be one
		// of the following: 
        //[ul]
	...
	// the 'Tools' tab in the customize dialog.  Returns 'true' if successful,
