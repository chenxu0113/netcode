...
//////////////////////////////////////////////////////////////////////
// This member function will set the font for the window specified by
// 'pWnd' and all of the child windows owned by 'pWnd'.
//
extern _XT_EXT_CLASS void AFXAPI _xtAfxChangeWindowFont(
    // Pointer to a valid CWnd object.
    CWnd* pWnd,
    // Pointer to the new font to set for the window.
    CFont* pFont);

//////////////////////////////////////////////////////////////////////
// This member function will draw an embossed icon from the image
...
//
extern _XT_EXT_CLASS void AFXAPI _xtAfxDrawEmbossed(
    // Pointer to the current device context.
    CDC* pDC,
    // Address of an image list.
    CImageList& imageList,
    // Index of the image in the image list.
    int nIndex,
    // XY location of where to draw the icon.
    CPoint point,
    // TRUE to draw the item in color, otherwise the
    // icon will be drawn with the default disabled look.
    BOOL bInColor);

///////////////////////////////////////////////////////////////////////
// This member function loads a bitmap from resource and translates the
// bitmap color such that they suit requirements for a toolbar bitmap.
// 
extern _XT_EXT_CLASS HBITMAP AFXAPI _xtAfxLoadSysColorBitmap(
    // Instance handle of the module that has the required resource.
    HINSTANCE hInst,
    // Bitmap resource handle.
    HRSRC hRsrc,
    // Tells if monochrome conversion shall be applied.
    BOOL bMono = FALSE);

//////////////////////////////////////////////////////////////////////
// This member function will draw a shadow rect into the specified
// device context.
//
extern _XT_EXT_CLASS void AFXAPI _xtAfxDrawShadedRect(
...
//////////////////////////////////////////////////////////////////////
// This member function will retrieve an HWND handle for the child window
// found directly under the cursor position specified by 'pt'.
//
// Returns an HWND handle for the child window at 'pt'.
//
extern _XT_EXT_CLASS HWND AFXAPI _xtAfxChildWindowFromPoint(
    // HWND handle of the parent window to find the child for.
    HWND hWnd,
...
//
extern _XT_EXT_CLASS void AFXAPI _xtAfxStripMnemonics(
    // A reference to a CString object.
    CString& strText);

//////////////////////////////////////////////////////////////////////
// This member function will test for the existence of a file or folder.
//
// Returns TRUE if successful, otherwise returns FALSE.
//
extern _XT_EXT_CLASS BOOL AFXAPI _xtAfxExist(
    // Fully qualified path for the item to find.
    LPCTSTR lpszFileName);

//////////////////////////////////////////////////////////////////////
// This member function parses a path for the next path component, not
...
//
extern _XT_EXT_CLASS LPTSTR AFXAPI _xtAfxPathFindNextComponent(
    // Pointer to a NULL-terminated string with the path.  Paths are delimited 
...
//
extern _XT_EXT_CLASS CWnd* AFXAPI _xtAfxCreateView(
    // Points to the parent of the view to be created.  The parent must be
	// valid.
    CWnd* pParentWnd,
    // CView runtime class.
    CRuntimeClass *pViewClass,
    // CDocument associated with the view. It can be NULL.
    CDocument *pDocument=NULL,
    // Create context for the view. It can be NULL.
    CCreateContext *pContext=NULL,
    // Default style for the view.
    DWORD dwStyle=AFX_WS_DEFAULT_VIEW,
    // Owner of the view. If NULL, 'pParentWnd' is used.
    CWnd* pOwnerWnd=NULL,
	// Control ID of the view.
	UINT nID=AFX_IDW_PANE_FIRST);

//////////////////////////////////////////////////////////////////////
// This member function is a callback function used by CXTShellTreeCtrl
...
//
extern _XT_EXT_CLASS int CALLBACK _xtAfxTreeViewCompareProc(
    // Corresponds to the lParam member of the TV_ITEM structure for the 
    // two items being compared.
    LPARAM lparam1,
    // Corresponds to the lParam member of the TV_ITEM structure for the 
    // two items being compared.
    LPARAM lparam2,
    // The 'lParamSort' member corresponds to the lParam member of TV_SORTCB.
    LPARAM lparamSort);

//////////////////////////////////////////////////////////////////////
// This member function is a callback function used by CXTShellListCtrl
...
// if the two items are equivalent.
//
extern _XT_EXT_CLASS int CALLBACK _xtAfxListViewCompareProc(
    // Corresponds to the lParam member of the LV_ITEM structure for the 
    // two items being compared.
    LPARAM lparam1,
    // Corresponds to the lParam member of the LV_ITEM structure for the 
    // two items being compared.
    LPARAM lparam2,
    // The 'lParamSort' member corresponds to the lParam member of LV_SORTCB.
    LPARAM lparamSort);
...
//////////////////////////////////////////////////////////////////////
// CXTColorPicker - The DDX_XTColorPicker function manages the transfer
...
//
extern _XT_EXT_CLASS void AFXAPI DDX_XTColorPicker(
    // A pointer to a CDataExchange object. The framework supplies this
	// object to establish the context of the data exchange, including its
	// direction.    
    CDataExchange* pDX,
    // The resource ID of the color picker control associated with the
	// control property.
    int nIDC,
    // A reference to a member variable of the dialog box, form view, or
	// control view object with which data is exchanged.
    COLORREF& value);

//:Associate with "Dialog Data Exchange"
//////////////////////////////////////////////////////////////////////
// CXTDateTimeCtrl - The DDX_XTDateTimeCtrl function manages the transfer
...
//
extern _XT_EXT_CLASS void AFXAPI DDX_XTDateTimeCtrl(
    // A pointer to a CDataExchange object.  The framework supplies this
	// object to establish the context of the data exchange, including its
	// direction.  You do not need to delete this object.
    CDataExchange* pDX,
    // The resource ID of the date and time picker control associated with
	// the member variable.
    int nIDC,
    // A reference to a COleDateTime member variable, dialog box, form
...
extern _XT_EXT_CLASS void AFXAPI DDX_XTDateTimeCtrl(
	...
	// the member variable.
    int nIDC,
    // A reference to a CTime member variable, dialog box, form view, or
	// control view object with which data is exchanged. 
    CTime& value);

//:Associate with "Dialog Data Validation"
//////////////////////////////////////////////////////////////////////
// CXTDateTimeCtrl - Call DDV_XTMinMaxDateTime to verify that the time/date
// value in the date and time picker control (CXTDateTimeCtrl) associated
// with 'refValue' falls between 'pMinRange' and 'pMaxRange'.
//
extern _XT_EXT_CLASS void AFXAPI DDV_XTMinMaxDateTime(
    // A pointer to a CDataExchange object.  The framework supplies this
	// object to establish the context of the data exchange, including its
	// direction. You do not need to delete this object.
    CDataExchange* pDX,
    // A reference to a CTime object associated with a member variable
...
extern _XT_EXT_CLASS void AFXAPI DDV_XTMinMaxDateTime(
	...
	// direction.   You do not need to delete this object.
    CDataExchange* pDX,
    // A reference to a COleDateTime object associated with a member variable
...
//:Associate with "Dialog Data Exchange"
//////////////////////////////////////////////////////////////////////
// CXTMonthCalCtrl - The DDX_XTMonthCalCtrl function manages the transfer
...
//
// Note:  The control manages a date value only.  The time fields in the
...
//
extern _XT_EXT_CLASS void AFXAPI DDX_XTMonthCalCtrl(
    // A pointer to a CDataExchange object.  The framework supplies this
	// object to establish the context of the data exchange, including its
	// direction. You do not need to delete this object.
    CDataExchange* pDX,
    // The resource ID of the month calendar control associated with the
	// member variable.
    int nIDC,
    // A reference to a COleDateTime member variable of the dialog box,
...
extern _XT_EXT_CLASS void AFXAPI DDX_XTMonthCalCtrl(
	...
	// member variable.
    int nIDC,
    // A reference to a CTime member variable of the dialog box, form view,
	// or control view object with which data is exchanged. 
    CTime& value);

//:Associate with "Dialog Data Validation"
//////////////////////////////////////////////////////////////////////
// CXTMonthCalCtrl - Call DDV_XTMinMaxMonth to verify that the time/date
// value in the month calendar control (CXTMonthCalCtrl) associated with
// 'refValue' falls between 'pMinRange' and 'pMaxRange'.
//
extern _XT_EXT_CLASS void AFXAPI DDV_XTMinMaxMonth(
    // A pointer to a CDataExchange object.  The framework supplies this
	// object to establish the context of the data exchange, including its
	// direction.
    CDataExchange* pDX,
    // A reference to an object of type CTime associated with a member
...
//:Associate with "Dialog Data Exchange"
//////////////////////////////////////////////////////////////////////
// CXTDateEdit - The DDX_XTOleDateTime function manages the transfer of
...
//
extern _XT_EXT_CLASS void AFXAPI DDX_XTOleDateTime(
    // A pointer to a CDataExchange object.  The framework supplies this
	// object to establish the context of the data exchange, including its
	// direction.    
    CDataExchange* pDX,
    // The resource ID of the date edit control associated with the control
	// property.
    int nIDC,
    // A reference to a member variable of the dialog box, form view, or
	// control view object with which data is exchanged.
    CXTDateEdit& rControl,
    // A reference to a member variable of the dialog box, form view, or
	// control view object with which data is exchanged.
