...
// used for BCGM_GRID_ITEM_CHANGED, BCGM_GRID_ITEM_BEGININPLACEEDIT, BCGM_GRID_ITEM_ENDINPLACEEDIT messages
...
public:
	...
	static CString  m_strFormatLongLong;//MSW 130530 ADD
	static CString  m_strFormatULongLong;//MSW 130530 ADD
...
public:
	...
	COLORREF GetOldColor () const	// MSW 120222 ADD
	{
		return m_OldColor;
	}
...
protected:
	...
	COLORREF					m_OldColor;			// Color value-old,MSW 120222 ADD
